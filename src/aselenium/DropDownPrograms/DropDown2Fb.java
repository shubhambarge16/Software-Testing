...
public class DropDown2Fb 
{
	public static void main(String[] args) throws InterruptedException 
	{
//On create new account page on FB, entering Birth date by drop down.
...
//now we've to select any particular day. & webdriver & webelement interfaces don't have any 
//methods to select the day/option.
